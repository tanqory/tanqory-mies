...
const config: Config = {
  ...
  plugins: [
    // Temporarily disabling search to fix compilation issues
    // [
  ...
  themeConfig: {
    ...
    // Algolia DocSearch - enabled with correct credentials  
    algolia: {
      appId: 'C5H0VAS3BI',
      apiKey: '372b89a44c58dc947b6559d2b8d2f878',
      indexName: 'movies_index',
      contextualSearch: true,
      searchPagePath: false,
      // For localhost development, search will use existing movie data
      // When deployed, use Algolia Crawler to index actual docs
    },
